...
* Максимальная длительность аудио: 7 минут.
* Команда `/buy` показывает кнопку покупки (20 попыток за 700 ₽) прямо в Telegram.
* Каждый новый пользователь получает 5 бесплатных попыток.
